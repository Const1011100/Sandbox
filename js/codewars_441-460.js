...
// ================================================================================================
// ================================================================================================
//*-Task №457 Fix my method (7kyu)
/*
Я наче новачок у кодуванні, тому не знаю, що не так із моїм кодом.
Властивість objMethod має викликати myFunction.
Чи можете ви виправити синтаксис, щоб myFunction знову працював? Перевірте фігурні дужки,
коми та регістр літер.
ВАЖЛИВО: повернення лише "рядка" недостатньо. Ми зобов’язані використовувати нотацію об’єктного літералу.
*/
...
Створіть шаблон Singleton, щоб у системі був один об’єкт.
