...
// ================================================================================================
// ================================================================================================
//*-Task №819 last digits of a number (7kyu)
/*
Ваше завдання — реалізувати функцію, яка повертає останні D цифр цілого числа N у вигляді списку.

Особливі випадки:
Якщо D > (кількість цифр N), повернути всі цифри.
Якщо D <= 0, повернути порожній список.
Приклади:
N = 1
D = 1
результат = [1]
...
// ================================================================================================
// ================================================================================================
//*-Task №820 Extra Perfect Numbers (Special Numbers Series #7) (7kyu)
/*
Визначення
Досконале число — це додатне ціле число, перший та останній біти якого в двійковому представленні
встановлені (тобто обидва дорівнюють 1).

Завдання
Для даного додатного цілого числа N повернути всі досконалі числа в діапазоні від 1 до N включно.

Розминка (рекомендовано)
Частина серії «Гра з числами»

Примітки
Вхідні дані завжди є додатним цілим числом.
Повернений список/масив повинен містити досконалі числа у порядку зростання, від найменшого до
найбільшого. Досконалі числа відповідають двійковим представленням, які починаються та закінчуються на 1.

Ввід >> Вивід Приклади
extraPerfect(3) ==> return {1, 3}
Пояснення:
1 у двійковій системі дорівнює 1 → перший та останній біти встановлені.
3 у двійковій системі дорівнює 11 → перший та останній біти встановлені.
extraPerfect(7) ==> return {1, 3, 5, 7}
Пояснення:
5 у двійковій системі дорівнює 101 → перший та останній біти встановлені.
7 у двійковій системі числення дорівнює 111 → перший та останній біти встановлені.
*/
