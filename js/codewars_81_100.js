...
// ================================================================================================
// ================================================================================================
//*-Task №99 What is between? (8kyu)
/*
Завершіть функцію, яка приймає два цілі числа (a, b, де a < b) і повертає масив усіх цілих чисел
...
// Цікаві варіанти з Codewars
const between_ = (a, b) => Array.from(new Array(b - a + 1), (_, i) => a + i);

// ================================================================================================
// ================================================================================================
//*-Task №100 Difference of Volumes of Cuboids (8kyu)
/*
У цій простій вправі ви створите програму, яка братиме два списки цілих чисел, a і b.
Кожен список складатиметься з 3 натуральних чисел вище 0, що представляють розміри кубоїдів a і b.
Ви повинні знайти різницю об’ємів кубоїдів незалежно від того, який із них більший.

Наприклад, якщо передані параметри ([2, 2, 3], [5, 4, 1]), обсяг a дорівнює 12, а обсяг b — 20.
Таким чином, функція має повернути 8.
...
function findDifference(a, b) {
    return Math.abs(a.reduce((acum, elem) => { return acum * elem }) - b.reduce((acum, elem) => { return acum * elem }));
}
