...
//*-Task №76 Third Angle of a Triangle (8kyu)
/*
...
// ================================================================================================
// ================================================================================================
//*-Task №77 Beginner Series #4 Cockroach (8kyu)
/*
Тарган - одне з найшвидших комах. Напишіть функцію, яка приймає швидкість у км/год і повертає
її в см/с, округлену до цілого числа (= підлога).
1.08 --> 30
Примітка! Введенням є дійсне число (фактичний тип залежить від мови) і >= 0.
...
// Цікаві варіанти з Codewars
const cockroachSpeed_ = s => Math.floor(s / 0.036);
// ================================================================================================
// ================================================================================================
//*-Task №78 Get Planet Name By ID (8kyu)
/*
Функція не повертає правильні значення. Ви можете зрозуміти чому?
...
// Мій варіант
// Потрібно добавляти break піся кожного завершення коду який відноситься до case

// Цікаві варіанти з Codewars
// Ще варіант це писати return 'Mercury' замість name = 'Mercury'

// ================================================================================================
// ================================================================================================
//*-Task №79 Find the first non-consecutive number (8kyu)
/*
Ваше завдання знайти перший елемент масиву, який не є послідовним.
Під непослідовним ми маємо на увазі не точно на 1 більший за попередній елемент масиву.

Наприклад:
Якщо у нас є масив [1,2,3,4,6,7,8], то 1, потім 2, потім 3, потім 4 є послідовними, а 6 – ні,
тож це перше непослідовне число.

Якщо весь масив є послідовним, повертається null.
Масив завжди матиме принаймні 2 елементи, і всі елементи будуть числами. Усі номери також будуть
унікальними та в порядку зростання. Числа можуть бути додатними чи від’ємними, і перше непослідовне
також може бути будь-яким!
*/
...
// Цікаві варіанти з Codewars
function firstNonConsecutive_(arr) {
    for (let i = 0; i < arr.length - 1; ++i) { // length - 1 - тепер можна не перевіряти на undefined
        if (arr[i] + 1 !== arr[i + 1]) {
            return arr[i + 1]
        }
    }
...
// ================================================================================================
// ================================================================================================
//*-Task №80 Grasshopper - Check for factor (8kyu)
/*
Ця функція повинна перевіряти, чи є фактор фактором основи.
Повертає true, якщо це фактор, або false, якщо це не так.
Про фактори:
Фактори — це числа, які можна помножити, щоб отримати інше число.

2 і 3 є множниками 6, тому що: 2 * 3 = 6

Діленням чисел можна знайти множник. Якщо залишок дорівнює 0, то число є множником.
Ви можете використовувати оператор mod (%) у більшості мов, щоб перевірити залишок
Наприклад, 2 не є множником 7, оскільки: 7 % 2 = 1

Примітка: основа – невід’ємне число, множник – додатне число.
*/
...
// Цікаві варіанти з Codewars
const checkForFactor_ = (base, factor) => !(base % factor);
// ================================================================================================
// ================================================================================================
//*-осталось 302шт
