...
// ================================================================================================
// ================================================================================================
//*-Task №199 USD => CNY (8kyu)
/*
Створіть функцію, яка перетворює долари США (USD) на китайські юані (CNY).
Вхідні дані – це ціле число в доларах США, а вихідні дані мають бути рядком із сумою в юанях,
а потім «китайськими юанями».

Приклади (Input -> Output)
15 -> '101,25 китайських юанів'
465 -> '3138,75 Китайський юань'
Курс конвертації, який ви повинні використовувати, становить 6,75 CNY за кожен 1 долар США.
Усі числа мають бути представлені у вигляді рядка з 2 знаками після коми.
(наприклад, "21.00", НЕ "21.0" або "21")
*/
...
// Цікаві варіанти з Codewars
const usdcny_ = usd => `${(usd * 6.75).toFixed(2)} Chinese Yuan`;
// ================================================================================================
// ================================================================================================
//*-Task №200 Area of a Square (8kyu)
/*
Виконайте функцію, яка обчислює площу червоного квадрата, коли довжину дуги кола A задано як вхідні дані.
Поверніть результат, округлений до двох десяткових знаків.

Графік
Примітка: використовуйте значення π, надане вашою мовою (Math.PI)
*/
