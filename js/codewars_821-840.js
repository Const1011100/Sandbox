...
// ================================================================================================
// ================================================================================================
//*-Task №836 Number to digit tiers (7kyu)
/*
Створіть функцію, яка приймає число та повертає масив рядків, що містять число, обрізане на кожній цифрі.

Приклади
420 має повернути ["4", "42", "420"]
2017 має повернути ["2", "20", "201", "2017"]
2010 має повернути ["2", "20", "201", "2010"]
4020 має повернути ["4", "40", "402", "4020"]
80200 має повернути ["8", "80", "802", "8020", "80200"]
PS: Вхідні дані гарантовано мають бути цілим числом у діапазоні [0, 1000000]
*/
...
function createArrayOfTiers(num) {
  ...
  for (let i = 0; i < elements.length - 1; i++) {
    result.push(result[i] + elements[i + 1]);
  }
  return result;
}
// Цікаві варіанти з Codewars
function createArrayOfTiers_(num) {
  let prev = '';
...
// ================================================================================================
// ================================================================================================
//*-Task №837 Caffeine Script (7kyu)
/*
Завершіть функцію, яка приймає ненульове ціле число як аргумент.
Якщо ціле число ділиться на 3, поверніть рядок "Java".
Якщо ціле число ділиться на 3 і на 4, поверніть рядок "Coffee"
Якщо одна з наведених вище умов істинна, а ціле число парне, додайте "Script" у кінець рядка.
Якщо жодна з умов не істинна, поверніть рядок "mocha_missing!"
...
// Мій варіантfunction caffeineBuzz(n){
function caffeineBuzz(num) {
  let result = '';

  // Перевіряємо подільність на 3 та 4
  if (num % 3 === 0 && num % 4 === 0) {
    result = 'Coffee';
  } else if (num % 3 === 0) {
    result = 'Java';
  ...
  // Якщо одна з умов вище істинна і число парне
  if (result !== '' && num % 2 === 0) {
    result += 'Script';
  }

  // Якщо жодна з умов не істинна
  if (result === '') {
...
// ================================================================================================
// ================================================================================================
//*-Task №838 Convert the score (7kyu)
/*
Ви працюєте на футбольному стадіоні нижчої ліги і вам доручили автоматизувати табло.
Арбітр вигукне рахунок. Ви вже налаштували модуль розпізнавання голосу, який перетворює голос
арбітра на рядок, але озвучений рахунок потрібно перетворити на пару для табло!
Наприклад, «Рахунок чотири нуль» має повернути [4,0]
Рахунок будь-якої команди має діапазон від 0 до 9, і арбітр не буде щоразу говорити один і той
самий рядок, наприклад,
...
function scoreboard(str) {
  ...
  return str
    .toLowerCase()
    .split(/\W+/)
    .filter((word) => word in map)
    .map((word) => map[word])
    .slice(0, 2);
}

// Цікаві варіанти з Codewars
function scoreboard_(string) {
...
// ================================================================================================
// ================================================================================================
//*-Task №839 List of Presents (7kyu)
/*
Завдання:
Дівчина Лео попросила його купити список подарунків під час наступної поїздки, тепер він хоче знати,
скільки з них він зможе купити.

Напишіть функцію, щоб допомогти Лео. Перший параметр функції – це бюджет Лео; другий – це масив,
що містить ціну кожного подарунка. Ви повинні повернути ціле число, що представляє максимальну
кількість подарунків, яку Лео може купити.

Приклад:
Максимальний бюджет: 20
Список подарунків: [13, 2, 4, 6, 1]
Повинно повернути 4.

_ ПРИМІТКА: Усі числа будуть цілими числами >= 0, і масив ніколи не буде порожнім._
*/
...
function howManyGifts(maxBudget, gifts) {
  ...
  for (let i = 0; i < sortedGifts.length; i++) {
    if (sum + sortedGifts[i] <= maxBudget) {
      sum += sortedGifts[i];
      howManyGifts++;
    }
  }
...
// Цікаві варіанти з Codewars
function howManyGifts_(maxBudget, gifts) {
  gifts.sort((a, b) => a - b);
...
// ================================================================================================
//*-Task №840 Recycle! (7kyu)
/*
Ви влаштовуєте барбекю, і після барбекю у вас залишається трохи сміття для переробки.

Є 3 коробки для переробки: Червона: Пластик, Зелена: Скло, Синя: Картон.

Ви хочете відсортувати сміття за матеріалом і повернути кількість предметів у кожній коробці у вигляді масиву (або кортежу в Python):

[пластик, скло, картка]
Тип матеріалу можна визначити на основі знака значення предмета:

Пластик: значення > 0
Скло: значення < 0
Картка: значення = 0
Приклад
сміття = [5, -9, 0, 6, -84, -95, 15]
// Пластик = 3, Скло = 3, Картон = 1
// Вивід: [3, 3, 1]
*/

// Мій варіантfunction {
function recycleMe(rubbish) {
  return [
    rubbish.filter((item) => item > 0).length, // plastic
    rubbish.filter((item) => item < 0).length, // glass
    rubbish.filter((item) => item === 0).length, // card
  ];
}
// Цікаві варіанти з Codewars
const recycleMe_ = (r) => {
