...
// ================================================================================================
// ================================================================================================
//*-Task №558 Strong Number (Special Numbers Series #2) (7kyu)
/*
Сильне число — це число, сума факторіелів цифр якого дорівнює самому числу.
Наприклад, 145 - це сильно, тому що 1! + 4! + 5! = 1 + 24 + 120 = 145.

Дано позитивне число, визначте, чи є воно сильним, і поверніть або "STRONG!!!!" або "Not Strong !!".

Приклади
1 - сильне число, тому що 1! = 1, тому поверніть "СИЛЬНО!!!!".
123 не є сильним числом, тому що 1! + 2! + 3! = 9 не дорівнює 123, тому поверніть «Не сильно!!».
145 - сильне число, тому що 1! + 4! + 5! = 1 + 24 + 120 = 145, тому поверніть «СИЛЬНО!!!!».
150 не є сильним числом, тому що 1! + 5! + 0! = 122 не дорівнює 150, тому поверніть «Не сильно!!».
*/
...
//*-Task №560 (7kyu)
/*
У нашого хлопця з фруктами є мішок із фруктами (представлений у вигляді низки ниток),
де деякі фрукти гнилі. Він хоче замінити всі гнилі шматочки фруктів свіжими.
Наприклад, задано ["apple","rottenBanana","apple"] замінений масив має бути ["apple","banana","apple"].
Ваше завдання полягає в тому, щоб реалізувати метод, який приймає масив рядків, що містять фрукти,
повинен повертати масив рядків, де всі гнилі фрукти замінені хорошими.

Примітки
Якщо масив має значення null/nil/None або порожній, вам слід повернути порожній масив ([]).
Назва гнилого фрукта буде в цьому верблюді (rottenFruit).
Повернений масив має бути в нижньому регістрі.
*/
...
function removeRotten(bagOfFruits) {
    ...
    return bagOfFruits.map((fruit) =>
        fruit.replace(/^rotten/i, '').toLowerCase()
    );
}
// Цікаві варіанти з Codewars
function removeRotten_(arr) {
