...
// ================================================================================================
// ================================================================================================
//*-Task №620 Something 's fishy... (7kyu)
/*
Ця ката має одну просту вимогу, повертати 3 як суму трьох змінних, що містять значення 1, але
у викривленому вигляді...
Цей початковий код виглядає правильно, але не працює. Ваше завдання знайти проблему та виправити її.
Примітка. Ви не маєте права змінювати місця, де ініціалізуються ці змінні, а також не можете
змінювати значення на будь-що, окрім 1, і ви також не повинні торкатися оператора return.
*/
