...
//*-Task №233 Power (8kyu)
/*
Мета полягає в тому, щоб створити функцію з двома вхідними числами та степенем, яка «зводить»
число до степеня (тобто множить число на саму ступінь).
numberToPower(3, 2) // -> 9 ( = 3 * 3 )
numberToPower(2, 3) // -> 8 ( = 2 * 2 * 2 )
numberToPower(10, 6) // -> 1000000
Примітка.
Math.pow і деякі інші математичні функції, такі як eval() і **, вимкнені.
*/
...
// Цікаві варіанти з Codewars
function numberToPower_(number, power) {
    var total = 1;
...
//
const numberToPower__ = (number, power) => power > 0 ? number * numberToPower(number, power - 1) : 1;
// ================================================================================================
// ================================================================================================
//*-Task №234 The 'if' function (8kyu)
/*
Створіть функцію під назвою _if, яка приймає 3 аргументи: значення bool і 2 функції
(які не приймають жодних параметрів): func1 і func2
Якщо bool є правдивим, слід викликати func1, інакше викликати func2.
...
// ================================================================================================
// ================================================================================================
//*-Task №235 Regexp Basics - is it a digit? (8kyu)
/*
Реалізувати String#digit?, який має повертати true,
якщо даний об’єкт є цифрою (0-9), і false в іншому випадку.
*/
...
// Цікаві варіанти з Codewars
String.prototype.digit_ = function () {
    return /^\d$/.test(this);
};
// ================================================================================================
// ================================================================================================
//*-Task №236 Incorrect division method (8kyu)
/*
Цей метод, який має повертати результат ділення першого аргументу на другий,
не завжди повертає правильні значення. Виправ це.
*/
...
// ================================================================================================
// ================================================================================================
//*-Task №239 ASCII Total (8kyu)
/*
Вам буде надано рядок, і ви повинні повернути суму всіх символів як int.
Функція повинна мати можливість обробляти всі друковані символи ASCII.
приклади:
uniTotal("a") == 97
uniTotal("aaa") == 291
*/
...
function uniTotal(string) {
    ...
    const int = letters.map(letter => {
        return letter.charCodeAt();
    })
    const sum = int.reduce((accum, num) => {
        return accum + num;
    }, 0)
    return sum;
}
...
// ================================================================================================
// ================================================================================================
//*-Task №240 Template Strings (8kyu)
/*
Рядки шаблону
Шаблонні рядки, ця ката головним чином спрямована на нове оновлення JS ES6, яке представляє
шаблонні рядки

Ваше завдання — повернути правильний рядок за допомогою функції Template String.
Введення
Два рядки, перевірка не потрібна.
Вихід
Ви повинні вивести рядок, що містить два рядки зі словом ```' є '```
*/
