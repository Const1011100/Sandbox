...
// ================================================================================================
// ================================================================================================
//*-Task №739 Responsible Drinking (7kyu)
/*
Ласкаво просимо до бару Codewars!
Бар Codewars рекомендує випивати 1 склянку води на кожен стандартний напій, щоб у вас не було
похмілля завтра вранці.

Ваші колеги-програмісти купили вам кілька напоїв сьогодні ввечері у вигляді рядка.
Поверніть рядокіз пропозицією, скільки склянок води вам слід випити, щоб не мати похмілля.
Приклади:
"1 beer"  -->  "1 glass of water"
бо ти випив один стандартний напій

"1 shot, 5 beers, 2 shots, 1 glass of wine, 1 beer"  -->  "10 glasses of water"
бо ти випив десять стандартних напоїв

Примітка:
Для спрощення ми вважатимемо, що будь-яка «пронумерована річ» у рядку є напоєм.
Навіть «1 ведмідь» -> «1 склянка води»; або «1 бензопила та 2 басейни» -> «3 склянки води»...
*/
...
function hydrate(s) {
  ...
  let dishes = amount > 1 ? 'glasses' : 'glass';
  return `${amount} ${dishes} of water`;
}
// Цікаві варіанти з Codewars
function hydrate_(s) {
  let answer = 0;
...
// ================================================================================================
// ================================================================================================
//*-Task №740 Is n divisible by (...)? (7kyu)
/*
Створіть функцію, яка перевіряє, чи ділиться перший аргумент n на всі інші аргументи
(повертає true, якщо інших аргументів немає).

Приклад:
(6,1,3)--> true, оскільки 6 ділиться на 1 та 3
(12,2)--> true, оскільки 12 ділиться на 2
(100,5,4,10,25,20)--> true
(12,7)--> false, оскільки 12 не ділиться на 7
*/

// Мій варіант
function isDivisible(n, ...numbers) {
  return !numbers.some((number) => n % number !== 0);
}
// Цікаві варіанти з Codewars
function isDivisible_(firstN, ...otherN) {
