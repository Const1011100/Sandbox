...
// ================================================================================================
// ================================================================================================
//*-Task №157 Determine offspring sex based on genes XX and XY chromosomes (8kyu)
/*
Чоловічі статеві клітини або сперматозоїди у людини та інших ссавців є гетерогаметними і містять
один із двох типів статевих хромосом. Вони або X, або Y. Однак жіночі гамети або яйцеклітини містять
лише Х-статеву хромосому і є гомогаметними.

У цьому випадку сперматозоїд визначає стать особини. Якщо сперматозоїд, що містить Х-хромосому,
запліднить яйцеклітину, отримана зигота буде XX або жіночою. Якщо сперматозоїд містить Y-хромосому,
то отримана зигота буде XY або чоловічою.

Визначте, чи буде стать нащадка чоловічою чи жіночою, виходячи з X- або Y-хромосоми, присутньої в
спермі чоловіка.

Якщо сперма містить Х-хромосому, поверніть "Congratulations! You're going to have a daughter.";
Якщо сперматозоїд містить Y-хромосому, поверніть  "Congratulations! You're going to have a son."
*/
...
// Цікаві варіанти з Codewars
const chromosomeCheck_ = sperm => `Congratulations! You're going to have a ${sperm === `XY` ? `son` : `daughter`}.`;

// ================================================================================================
// ================================================================================================
//*-Task №158 Multiplication table for number (8kyu)
/*
Ваша мета — повернути таблицю множення для числа, яке завжди є цілим числом від 1 до 10.
Наприклад, таблиця множення (рядок) для числа == 5 виглядає так:
1 * 5 = 5
2 * 5 = 10
3 * 5 = 15
4 * 5 = 20
...
9 * 5 = 45
10 * 5 = 50
P. S. Ви можете використовувати \n у рядку, щоб перейти до наступного рядка.
Примітка: між рядками слід додавати нові рядки, але в кінці не повинно бути символів нового рядка.
Якщо ви не впевнені щодо формату, перегляньте приклади тестів.
*/
...
//
function multiTable__(n) {
    return [...Array(10)].map((_, i) => `${i + 1} * ${n} = ${n * i + n}`).join('\n')
}

// ================================================================================================
// ================================================================================================
//*-Task №159 String Templates - Bug Fixing #5 (8kyu)
/*
О ні! Тіммі не дуже уважно дотримувався інструкцій і забув, як користуватися новою функцією
шаблону рядка. Допоможіть Тіммі з його шаблоном рядка, щоб він працював так, як він очікує!
*/
...
// Цікаві варіанти з Codewars
const buildString_ = (...template) => `I like ${template.join(', ')}!`;
// ================================================================================================
// ================================================================================================
//*-Task №160 Gravity Flip (8kyu)
/*
Якщо ви вже виконали цю ката і бажаєте більшого випробування, ось 3D-версія
Бобу нудно на уроках фізики, тому він зробив собі ящик для іграшок, щоб згаяти час. Ящик особливий
тим, що має можливість змінювати силу тяжіння.
У коробці є кілька колонок іграшкових кубиків, розташованих в лінію. В i-му стовпчику a_i кубиків.
Спочатку сила тяжіння в ящику тягне кубики вниз. Коли Боб перемикає гравітацію, він починає тягнути
всі кубики до певної сторони коробки, d, яка може бути або «L», або «R» (ліворуч або праворуч).
Нижче наведено приклад того, як може виглядати коробка з кубиками до і після зміни сили тяжіння.
...
Враховуючи початкову конфігурацію кубів у коробці, дізнайтеся, скільки кубиків у кожному з n стовпців
після того, як Боб перемкне силу тяжіння.
...
// Цікаві варіанти з Codewars
const flip_ = (d, a) => a.sort((x, y) => d === 'R' ? x - y : y - x);
