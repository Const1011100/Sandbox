...
// ================================================================================================
// ================================================================================================
//*-Task №137 Merge two sorted arrays into one (8kyu)
/*
Вам надано два відсортовані масиви, які містять лише цілі числа. Ваше завдання полягає в тому, щоб
знайти спосіб об'єднати їх в одну, відсортовану за зростанням.
Завершіть функцію mergeArrays(arr1, arr2), де arr1 і arr2 — вихідні відсортовані масиви.

Вам не потрібно турбуватися про перевірку, оскільки arr1 і arr2 мають бути масивами з 0 або більше
цілими числами. Якщо arr1 і arr2 порожні, тоді просто повертається порожній масив.

Примітка: arr1 і arr2 можуть бути відсортовані в різному порядку. Також arr1 і arr2 можуть мати
однакові цілі числа. Видалити дублікат у поверненому результаті.
...
//
function mergeArrays__(arr1, arr2) {
    return arr1
...
// ================================================================================================
// ================================================================================================
//*-Task №138 Find the position! (8kyu)
/*
Коли надається літера, поверніть її позицію в алфавіті.

Вхід :: "a"
Вивід :: "Позиція алфавіту: 1"
*/

// Мій варіант
function alphabetPosition(letter) {
    const lowercaseLetter = letter.toLowerCase();
    // Отримуємо ASCII код букви і віднімаємо код букви 'a'
    const position = lowercaseLetter.charCodeAt(0) - 'a'.charCodeAt(0) + 1;
    return `Position of alphabet: ${position}`;
}

// Цікаві варіанти з Codewars
const position_ = letter => `Position of alphabet: ${letter.charCodeAt() - 96}`;
//
function position__(letter) {
...
// ================================================================================================
// ================================================================================================
//*-Task №139 Reversing Words in a String (8kyu)
/*
Вам потрібно написати функцію, яка перевертає слова в заданому рядку. Слово також може поміститися
в порожній рядок. Якщо це недостатньо зрозуміло, ось кілька прикладів:

Оскільки введення може містити кінцеві пробіли, вам також потрібно ігнорувати непотрібні пробіли.
Приклад (введення --> вих
...
// ================================================================================================
// ================================================================================================
//*-Task №140 A wolf in sheep's clothing (8kyu)
/*
Вовки були повторно інтродуковані до Великої Британії. Ви займаєтеся вівчарством, і зараз вас
мучать вовки, які прикидаються вівцями. На щастя, ви добре вмієте їх помічати.

Попередьте вівцю перед вовком, що її ось-ось з’їдять. Пам’ятайте, що ви стоїте в першій частині черги,
яка знаходиться в кінці масиву:
...
Приклади
Введення: ["вівця", "вівця", "вівця", "вовк", "вівця"]
Вихід: "Ой! Вівця номер 1! Тебе ось-ось з'їсть вовк!"

Введення: ["вівця", "вівця", "вовк"]
Результат: «Будь ласка, йди геть і перестань їсти моїх овець»
*/
