...
// ================================================================================================
// ================================================================================================
//*-Task №217 Who is going to pay for the wall? (8kyu)
/*
Дон Драмфет живе в гарному районі, але один із його сусідів почав здавати його будинок.
Дон Драмфет хоче побудувати стіну між своїм будинком і будинком свого сусіда, і намагається змусити
місцеву асоціацію заплатити за це. Він починає просити своїх сусідів подати петицію, щоб асоціація
побудувала стіну. На жаль для Дона Драмфета, він не дуже добре читає, має дуже обмежений об’єм уваги
та може запам’ятати лише дві літери від кожного з імен своїх сусідів. Збираючи підписи, він наполягає,
щоб його сусіди скорочували свої імена, поки не залишиться дві літери, і він нарешті зможе їх прочитати.

Ваш код відображатиме повне ім’я сусіда та скорочену версію імені у вигляді масиву.
Якщо кількість символів у назві менше або дорівнює двом, він поверне масив, що містить лише ім’я, як є.
*/
...
// Цікаві варіанти з Codewars
function whoIsPaying_(name) {
    return name.length > 2 ? [name, name.slice(0, 2)] : [name]
}
// ================================================================================================
// ================================================================================================
//*-Task №218 Training JS #6: Basic data types--Boolean and conditional statements if..else (8kyu)
/*
Кодування у функції trueOrFalse, функція приймає 1 параметр:val, спробуйте використати умовний
оператор if...else, якщо значення val є false (val==false або воно може перетворитися на false),
має повернути рядок "false", якщо ні, поверніть рядок "true".
*/
...
// Цікаві варіанти з Codewars
function trueOrFalse_(val) {
    return Boolean(val).toString();
}
// ================================================================================================
// ================================================================================================
//*-Task №219 Swap Values (8kyu)
/*
Я хотів би мати можливість передати масив із двома елементами моїй функції swapValues, щоб поміняти
значення місцями. Однак здається, що значення не змінюються.
Ви можете зрозуміти, що тут не так?
*/
...
// Цікаві варіанти з Codewars
function swapValues_() {
    return arguments[0].reverse();
}
//
function swapValues__(arr) {
    return arr.reverse();
}
// ================================================================================================
// ================================================================================================
//*-Task №220 Name on billboard (8kyu)
/*
Ви можете надрукувати своє ім’я на рекламному щиті. Дізнайтеся, скільки це вам коштуватиме.
Ціна кожного символу за замовчуванням становить 30 фунтів стерлінгів, але вона може бути іншою,
якщо вам надано 2 параметри замість 1.

Ви не можете використовувати оператор множника "*".
Якби ваше ім'я було Jeong-Ho Aristotelis, реклама коштувала б 600 фунтів стерлінгів.
20 літер * 30 = 600 (пробіл вважається символом).
*/
...
// Цікаві варіанти з Codewars
function billboard_(name, price = 30) {
