...
// ================================================================================================
// ================================================================================================
//*-Task №418 Sum of the first nth term of Series (7kyu)
/*
Ваше завдання — написати функцію, яка повертає n-й член наступного ряду, який є сумою перших n
членів послідовності (n — вхідний параметр).
Серія: 1 + 1/4 + 1/7 + 1/10 + 1/13 + 1/16 + ...
Щоб завершити це, вам потрібно буде з’ясувати правило ряду.

Правила:
Вам потрібно округлити відповідь до 2 знаків після коми та повернути її як рядок.
Якщо дане значення дорівнює 0, воно має повернути "0,00".
...
// ================================================================================================
// ================================================================================================
//*-Task №419 Remove the minimum (7kyu)
/*
Музей неймовірно нудних речей
Музей неймовірно нудних речей хоче позбутися деяких експонатів. Міріам, архітектор інтер’єрів,
придумує план прибрати найнудніші експонати. Вона дає їм оцінку, а потім видаляє того, хто має
найнижчий рейтинг.
Однак як тільки вона закінчила оцінювати всі експонати, вона вирушила на важливий ярмарок,
тому вона просить вас написати програму, яка повідомлятиме їй рейтинги експонатів після видалення
найнижчого. Досить справедливо.

Дано масив цілих чисел, вилучіть найменше значення. Не змінюйте оригінальний масив/список.
Якщо є кілька елементів з однаковим значенням, видаліть той із найнижчим індексом.
Якщо ви отримуєте порожній масив/список, поверніть порожній масив/список.
...
// Цікаві варіанти з Codewars
function removeSmallest_(numbers) {
    let indexOfMin = numbers.indexOf(Math.min(...numbers));
    return [...numbers.slice(0, indexOfMin), ...numbers.slice(indexOfMin + 1)];
}
//
function removeSmallest__(numbers) {
    const min = Math.min.apply(this, numbers);
    return numbers.filter((num, idx, arr) => idx !== arr.indexOf(min));
}
// ================================================================================================
// ================================================================================================
//*-Task №420 The highest profit wins! (7kyu)
/*
Розповідь
У Бена є дуже проста ідея отримати прибуток: він щось купує і знову продає. Звичайно, це не далоб
йому жодного прибутку, якби він просто купував і продавав це за тією самою ціною.
Натомість він збирається купити його за найнижчою ціною та продати за найвищою.

Завдання
Напишіть функцію, яка повертає як мінімальне, так і максимальне число заданого списку/масиву.
...
Зауваження
Усі масиви або списки завжди матимуть принаймні один елемент, тому вам не потрібно перевіряти довжину.
Крім того, ваша функція завжди отримуватиме масив або список, вам не потрібно перевіряти значення null,
undefined або щось подібне.
*/
